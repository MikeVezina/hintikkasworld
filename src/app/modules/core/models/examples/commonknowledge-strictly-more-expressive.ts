...
export class CommonknowledgeStrictlyMoreExpressive extends ExampleDescription {
    getDescription(): string[] {
        return ["This example shows that Epistemic logic with common knowledge is strictly more expressive than Epistemic logic without common knowledge. In particular, it shows that it is not possible to express common knowledge with a formula of modal depth 3. Indeed, consider both models generated by executing one of the actions. Any formula of modal depth 3 cannot distinguish both models but formula CK p can."]
    }
